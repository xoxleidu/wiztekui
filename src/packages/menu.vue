...
import { addClass, removeClass, hasClass } from "../components/utils/dom";
...
export default {
  ...
  render(h) {
    const component = (
      <ul
        ...
        class={{
          "wz-menu--horizontal": this.mode === "horizontal",
          "wz-menu--vertical": this.mode === "vertical",
          "wz-menu--collapse": this.collapse,
          "wz-menu": true,
        }}
      >
        {this.$slots.default}
    ...
    if (this.collapseTransition) {
      return (
        <wz-menu-collapse-transition>{component}</wz-menu-collapse-transition>
      );
    } else {
      return component;
    }
      ...
      render(createElement, context) {
        const data = {
          ...
          on: {
            ...
            enter(el) {
              addClass(el, "wz-opacity-transition");
              el.style.opacity = 1;
            },

            afterEnter(el) {
              removeClass(el, "wz-opacity-transition");
              el.style.opacity = "";
            },
            ...
            beforeLeave(el) {
              ...
              if (hasClass(el, "wz-menu--collapse")) {
                removeClass(el, "wz-menu--collapse");
                el.dataset.oldOverflow = el.style.overflow;
                el.dataset.scrollWidth = el.clientWidth;
                addClass(el, "wz-menu--collapse");
              } else {
                addClass(el, "wz-menu--collapse");
                el.dataset.oldOverflow = el.style.overflow;
                el.dataset.scrollWidth = el.clientWidth;
  ...
  watch: {
    ...
    collapse(value) {
      ...
      this.broadcast("wzSubmenu", "toggle-collapse", value);
    },
  },
  methods: {
