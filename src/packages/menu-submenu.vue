...
export default {
  ...
  componentName: "wzSubmenu",

  mixins: [menuMixin, Groups,poperMixins],
  ...
  computed: {
    ...
    menuTransitionName() {
      return this.rootMenu.collapse ? "wz-zoom-in-left" : "wz-zoom-in-top";
    },
    opened() {
    ...
    isFirstLevel() {
      ...
      while (parent && parent !== this.rootMenu) {
        if (
          ["wzSubmenu", "wzMenuItemGroup"].indexOf(
  ...
  methods: {
    ...
    handleClick() {
      ...
      this.dispatch("wzMenu", "submenu-click", this);
    },
    handleMouseenter(event, showTimeout = this.showTimeout) {
      ...
      this.dispatch("wzSubmenu", "mouse-enter-child");
    ...
    handleMouseleave(deepDispatch = false) {
      ...
      this.dispatch("wzSubmenu", "mouse-leave-child");
      clearTimeout(this.timeout);
      this.timeout = setTimeout(() => {
      ...
      if (this.appendToBody && deepDispatch) {
        if (this.$parent.$options.name === "wzSubmenu") {
  ...
  render(h) {
    ...
    const popupMenu = (
      <transition name={menuTransitionName}>
        <div
          ref="menu"
          v-show={opened}
          class={[`wz-menu--${mode}`, popperClass]}
        ...
        >
          <ul
            role="menu"
            class={[
              "wz-menu wz-menu--popup",
              `wz-menu--popup-${currentPlacement}`,
            ]}
    ...
    return (
      ...
      >
        ...
        >
          {$slots.title}
          <i class={["wz-submenu__icon-arrow", submenuTitleIcon]}></i>
        </div>
