...
import { afterLeave, merge } from "../utils/util";
...
LoadingConstructor.prototype.close = function() {
  ...
  afterLeave(
    ...
    _ => {
      ...
      removeClass(target, "wz-loading-parent--relative");
      removeClass(target, "wz-loading-parent--hidden");
...
const Loading = (options = {}) => {
  ...
  if (
    ...
    addClass(parent, "wz-loading-parent--relative");
  }
  if (options.fullscreen && options.lock) {
    addClass(parent, "wz-loading-parent--hidden");
  }
